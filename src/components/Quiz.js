...
class Quiz extends Component {
  ...
  render() {
    const { correct, scramble, quiz, index, numberOfQuestions, score, completed, handleAnswerSelected, handleSubmit,logSuccess, nextSubmit, retakeQuiz, checked } = this.props
